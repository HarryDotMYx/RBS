<cfscript>
	mapper()
		...
		.get(name="register", pattern="/register", controller="registrations", action="new")
		.post(name="registerPost", pattern="/register/c", controller="registrations", action="create")
		.get(name="confirmEmail", pattern="/register/confirm/[key]", controller="registrations", action="confirm")
