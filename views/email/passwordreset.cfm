...
<p style="Margin-top: 0;color: ##565656;font-family: sans-serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">#linkto(controller="passwordResets", action="edit", onlyPath=false,  key=resetTokenValue)#</p>
